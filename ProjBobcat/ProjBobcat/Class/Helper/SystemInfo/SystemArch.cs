...
namespace ProjBobcat.Class.Helper.SystemInfo
{
    ...
    public class SystemArch : IFormattable, IEquatable<SystemArch>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return _is64BitOperatingSystem == arch._is64BitOperatingSystem;
            }
            return false;
        }
        /// <summary>
        ...
        public bool Equals(SystemArch other)
            => _is64BitOperatingSystem == other._is64BitOperatingSystem;
        /// <summary>
        /// 返回一个表示当前实例的字符串。
        /// 这将得到 "x64" 或 "x86"。
        /// </summary>
        ...
        {
            return string.IsNullOrEmpty(format) ? _is64BitOperatingSystem ? "64" : "86" :
        ...
        public static bool operator ==(SystemArch left, SystemArch right)
            => left?._is64BitOperatingSystem == right?._is64BitOperatingSystem;
        /// <summary>
        /// 
        /// </summary>
        /// <param name="left"></param>
