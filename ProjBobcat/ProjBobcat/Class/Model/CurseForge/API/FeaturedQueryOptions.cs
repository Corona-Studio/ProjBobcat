...
public class FeaturedQueryOptions
{
    ...
    [JsonProperty("addonIds")] public List<int> AddonIds { get; set; }

    [JsonProperty("featuredCount")] public int FeaturedCount { get; set; }

    [JsonProperty("popularCount")] public int PopularCount { get; set; }
