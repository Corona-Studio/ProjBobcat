...
namespace ProjBobcat.DefaultComponent.Launch.GameCore
{
    public abstract class GameCoreBase : IGameCore
    {
        ...
        public event EventHandler<GameExitEventArgs> GameExitEventDelegate
        {
            add
            {
                listEventDelegates.AddHandler(GameExitEventKey, value);
            }
            remove
            {
                listEventDelegates.RemoveHandler(GameExitEventKey, value);
            }
        }
        ...
        public event EventHandler<GameLogEventArgs> GameLogEventDelegate
        {
            add
            {
                listEventDelegates.AddHandler(GameLogEventKey, value);
            }
            remove
            {
                listEventDelegates.RemoveHandler(GameLogEventKey, value);
            }
        }
        ...
        public event EventHandler<LaunchLogEventArgs> LaunchLogEventDelegate
        {
            add
            {
                listEventDelegates.AddHandler(LaunchLogEventKey, value);
            }
            remove
            {
                listEventDelegates.RemoveHandler(LaunchLogEventKey, value);
            }
        }
